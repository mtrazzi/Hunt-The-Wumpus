...
public class PrincipalD {
	...
	public static void main(String[] args){
		...
		startAgents(agentList);
			...
			if(PLATFORM_isMAIN){
				...
				containerList.putAll(createAndConnectContainer("NOM_COURT", PLATFORM_HOSTNAME, PLATFORM_ID, PLATFORM_PORT));
	 ...
	 *@return the agentListPatricePerny
	 */
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		c = containerList.get("NOM_COURT");
		Assert.assertNotNull("This container does not exist",c);
		
		agentName="INDIANA_JONES";
